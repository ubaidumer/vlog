            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} sm={12} md={4}>
                <TextField
                  ...
                  helperText={
                    hasError('renting_duration')
                      ? formState.errors.renting_duration[0]
                      : null
                  }
                  error={hasError('renting_duration')}
                  onFocus={toggleDatePicker}
                  type="text"
                  value={formState.values.renting_duration || ''}
                />
                <DateRange
                  name="renting_duration_range"
