...
const FilesDropzoneN = ({
  ...
  const upState=()=>{
    uploadState(uploadStateKey,true);
      ...
      {files.length > 0 && files.length < 10 && (
        <>
          ...
          <div className={classes.actions}>
            ...
            <Button onClick={upState}  color="secondary" size="small" variant="contained">
              Upload files
            </Button>
          </div>
        </>
